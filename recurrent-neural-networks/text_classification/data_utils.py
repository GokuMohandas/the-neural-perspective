...
def create_vocabulary(X, max_vocabulary_size=5000):
	...
	# Get list of all vocab words starting with [_PAD, _GO, _EOS, _UNK] and then words sorted by count
...
def split_data(X, y, seq_lens, train_ratio=0.8):
	...
	X, y, seq_lens = X[shuffle_indices], y[shuffle_indices], seq_lens[shuffle_indices]
